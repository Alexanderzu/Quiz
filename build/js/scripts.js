	...
	(function($){
	    $.slickQuiz = function(element, options) {
	        var plugin   = this,
	            ...
	            defaults = {
	                checkAnswerText:  'Продолжить',
	                nextQuestionText: 'Продолжить',
	                backButtonText: '',
	                completeQuizText: '',
	                tryAgainText: 'Пройти еще раз',
	                questionCountText: '%current/%total',
	                preventUnansweredText: 'You must select at least one answer.',
	                questionTemplateText:  '%count %text',
	                scoreTemplateText: '%score из %total правильных ответов',
	            ...
	            _textResponse          = '.' + textResponseClass,
	        ...
	        plugin.method = {
	                    ...
	                    if (questions.hasOwnProperty(i)) {
	                        ...
	                        if (plugin.config.displayQuestionNumber) {
	                            formatQuestion = plugin.config.questionTemplateText
	                                .replace('%count', "").replace('%text', question.q);
	                        } else {
	                        ...
	                        for (i in answers) {
	                            if (answers.hasOwnProperty(i)) {
	                                ...
	                                var textLabel = '<div class="answertext">' + answer.text + '</div>'
	
	                                // var answerContent = $('<li ></li>')
	
	                                
	                                
	                                var answerContent = $('<li class="answer" onclick="clickAnswer(this);"></li>')
	                                    .append(input)
	                                    .append(optionLabel)
	                                    .append(textLabel);
	                        ...
	                        if (plugin.config.perQuestionResponseMessaging || plugin.config.completionResponseMessaging) {
	                            ...
	                            responseHTML.append('<li class="' + textResponseClass + '">' + answerContent.textLabel+ '</li>');
	            ...
	            resetQuiz: function(startButton, options) {
	                ...
	                $quizResults.fadeOut(300, function() {
	                    ...
	                    // $(_element + ' ' + _answers).removeClass(checkAnswerList);
	                    $(".checkAnswerList").removeClass("checkAnswerList");
	            ...
	            completeQuiz: function(options) {
	                ...
	                if (plugin.config.disableRanking) {
	                    ...
	                    var levels    = [
	                            quizValues.info.level0,
	                            quizValues.info.level1, // 81-100%
	                            quizValues.info.level2, // 61-80%
	                            quizValues.info.level3, // 41-60%
	                            quizValues.info.level4, // 21-40%
	                            quizValues.info.level5,  // 0-20%
	                            quizValues.info.level6, 
	                            quizValues.info.level7,
	                            quizValues.info.level8,
	                        ],
	        ...
	        plugin.init = function() {
	            ...
	            // plugin.method.rrr(this, {callback: plugin.config.animationCallbacks.rrr});
	
	            $(_answer ).on('click', function(e) {
